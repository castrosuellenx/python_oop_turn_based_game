...
# Herói: classe filha - herda tudo da classe Personagem - é controlado pelo usuário
# Inimigo: classe filha - herda tudo da classe Personagem - é controlado pelo computador
...
class Jogo:
    ...
    def __init__(self) -> None:
        self.heroi = Heroi(nome="Herói", vida=70, nivel=5, habilidade="Magia")
        self.inimigo = Inimigo(nome="Inimigo", vida=100, nivel=3, tipo="Monstro")
